...
export function buildSeedPayload(
  ...
  const expenses: Transaction[] = [
    // Ingresos mensuales (sin categoría de presupuesto — son ingresos)
    {
      ...
      amt: 1800, date: date(2, 1), type: 'monthly', kind: 'income',
      tags: ['#trabajo'], notes: '', paid: paidPast, paidAt: paidAtPast,
    },
    {
      id: nid(), uid: userBId, cat: 'savings', iconColor: 'teal',
      desc: 'Salario', account: 'Cuenta nómina',
      amt: 1500, date: date(2, 1), type: 'monthly', kind: 'income',
      tags: ['#trabajo'], notes: '', paid: paidPast, paidAt: paidAtPast,
    },
    {
      id: nid(), uid: userAId, cat: 'tech', iconColor: 'blue',
      desc: 'Proyecto freelance', account: 'Cuenta personal',
      amt: 350, date: date(1, 18), type: 'once', kind: 'income',
    ...
    // Hogar y Servicios
    {
      ...
      amt: 850, date: date(2, 1), type: 'monthly', kind: 'expense',
      tags: ['#hogar'], notes: '', paid: paidPast, paidAt: paidAtPast,
      budgetCatId: catHogarId,
    },
    {
      id: nid(), uid: userAId, cat: 'utilities', iconColor: 'amber',
      desc: 'Luz y agua', account: 'Cuenta personal',
      amt: 78, date: date(2, 5), type: 'monthly', kind: 'expense',
      tags: ['#servicios'], notes: '', paid: paidAll, paidAt: paidAtAll,
      budgetCatId: catHogarId,
    },
    {
      id: nid(), uid: userAId, cat: 'wifi', iconColor: 'sky',
      desc: 'Internet en casa', account: 'Cuenta personal',
      amt: 35, date: date(2, 5), type: 'monthly', kind: 'expense',
      tags: ['#servicios'], notes: '', paid: paidAll, paidAt: paidAtAll,
      budgetCatId: catHogarId,
    },
    {
      ...
      amt: 25, date: date(2, 5), type: 'monthly', kind: 'expense',
      tags: ['#servicios'], notes: '', paid: paidAll, paidAt: paidAtAll,
      budgetCatId: catHogarId,
    },
    ...
    // Ocio y Entretenimiento
    {
      ...
      amt: 13.99, date: date(2, 10), type: 'monthly', kind: 'expense',
      tags: ['#suscripcion'], notes: '', paid: paidAll, paidAt: paidAtAll,
      budgetCatId: catOcioId,
    },
    {
      id: nid(), uid: userBId, cat: 'entertainment', iconColor: 'red',
      desc: 'Netflix', account: 'Tarjeta',
      amt: 17.99, date: date(2, 10), type: 'monthly', kind: 'expense',
      tags: ['#suscripcion'], notes: '', paid: paidAll, paidAt: paidAtAll,
      budgetCatId: catOcioId,
    },
    ...
    // Salud y Bienestar
    {
      ...
      amt: 30, date: date(2, 8), type: 'monthly', kind: 'expense',
      tags: ['#salud'], notes: '', paid: paidAll, paidAt: paidAtAll,
    ...
    // Gastos únicos — hace 2 meses
    {
      ...
      amt: 148, date: date(2, 14), type: 'once', kind: 'expense',
      tags: ['#comida'], notes: '',
    ...
    },
    {
      ...
      amt: 72, date: date(2, 16), type: 'once', kind: 'expense',
      tags: ['#restaurante'], notes: 'Aniversario',
      budgetCatId: catAlimentacionId,
    },
    {
      id: nid(), uid: userAId, cat: 'coffee', iconColor: 'amber',
      desc: 'Cafés de la semana', account: 'Efectivo',
      amt: 18, date: date(2, 20), type: 'once', kind: 'expense',
      tags: ['#cafe'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      ...
      amt: 32, date: date(2, 22), type: 'once', kind: 'expense',
      tags: ['#salud'], notes: '',
      budgetCatId: catSaludId,
    },
    {
      ...
      amt: 95, date: date(2, 25), type: 'once', kind: 'expense',
      tags: ['#ropa'], notes: '',
    ...
    },
    {
      ...
      amt: 22, date: date(2, 27), type: 'once', kind: 'expense',
      tags: ['#transporte'], notes: '',
    ...
    // Gastos únicos — mes pasado
    {
      ...
      desc: 'Supermercado', account: 'Tarjeta',
      amt: 162, date: date(1, 6), type: 'once', kind: 'expense',
      tags: ['#comida'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      ...
      amt: 85, date: date(1, 12), type: 'once', kind: 'expense',
      tags: ['#restaurante'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      id: nid(), uid: userAId, cat: 'coffee', iconColor: 'amber',
      desc: 'Cafés', account: 'Efectivo',
      amt: 24, date: date(1, 15), type: 'once', kind: 'expense',
      tags: ['#cafe'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      ...
      amt: 28, date: date(1, 19), type: 'once', kind: 'expense',
      tags: ['#ocio'], notes: '',
      budgetCatId: catOcioId,
    },
    {
      ...
      amt: 67, date: date(1, 21), type: 'once', kind: 'expense',
      tags: ['#compras'], notes: '',
      budgetCatId: catComprasId,
    },
    {
      ...
      amt: 55, date: date(1, 24), type: 'once', kind: 'expense',
      tags: ['#transporte', '#auto'], notes: '',
      budgetCatId: catTransporteId,
    },
    {
      id: nid(), uid: userBId, cat: 'events', iconColor: 'rose',
      desc: 'Regalo cumpleaños amiga', account: 'Efectivo',
      amt: 45, date: date(1, 28), type: 'once', kind: 'expense',
      tags: ['#regalo'], notes: '',
      budgetCatId: catOcioId,
    },
    {
      id: nid(), uid: userAId, cat: 'groceries', iconColor: 'lime',
      desc: 'Supermercado', account: 'Tarjeta',
      amt: 88, date: date(1, 28), type: 'once', kind: 'expense',
      tags: ['#comida'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    ...
    // Gastos únicos — mes actual
    {
      ...
      desc: 'Supermercado', account: 'Tarjeta',
      amt: 78, date: date(0, 3), type: 'once', kind: 'expense',
      tags: ['#comida'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      ...
      amt: 11, date: date(0, 8), type: 'once', kind: 'expense',
      tags: ['#cafe'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      ...
      amt: 58, date: date(0, 10), type: 'once', kind: 'expense',
      tags: ['#trabajo', '#comida'], notes: '',
      budgetCatId: catAlimentacionId,
    },
    {
      id: nid(), uid: userBId, cat: 'subscriptions', iconColor: 'indigo',
      desc: 'Adobe Creative Cloud', account: 'Tarjeta',
      amt: 24.99, date: date(0, 12), type: 'once', kind: 'expense',
      tags: ['#suscripcion', '#trabajo'], notes: '',
      budgetCatId: catOcioId,
    },
  ];
